...
LEFT JOIN Registrations r 
    ...
    AND r.registration_date >= DATE('2025-07-15') - INTERVAL 90 DAY
...
FROM Users
WHERE registration_date >= DATE('2025-07-15') - INTERVAL 7 DAY
...
WHERE u.registration_date >= DATE('2025-07-15') - INTERVAL 30 DAY
...
FROM Registrations
WHERE registration_date >= DATE('2025-07-15') - INTERVAL 12 MONTH
