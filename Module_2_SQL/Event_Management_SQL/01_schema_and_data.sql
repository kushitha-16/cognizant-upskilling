...
('Tech Innovators Meetup', 'A meetup for tech enthusiasts.', 'New York', '2025-06-10 10:00:00', '2025-06-10 16:00:00', 'completed', 1),
('AI & ML Conference', 'Conference on AI and ML advancements.', 'Los Angeles', '2025-05-15 09:00:00', '2025-05-15 17:00:00', 'completed', 3),
('Frontend Development Bootcamp', 'Hands-on training on frontend tech.', 'Chicago', '2025-07-01 10:00:00', '2025-07-03 16:00:00', 'upcoming', 2);
...
(1, 'pdf', 'tech_meetup_agenda.pdf', '2025-05-01 10:00:00'),
(2, 'image', 'ai_poster.jpg', '2025-04-20 09:00:00'),
(3, 'link', 'html5_docs', '2025-06-25 15:00:00');

SELECT 'Schema and sample data created successfully' AS message;